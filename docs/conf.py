...
classname = "F5 Multi Cloud Implementations using Application Connector and FQDN Pools"

# OPTIONAL: The URL to the GitHub Repository for this class
github_repo = "https://github.com/f5devcentral/F5 Multi Cloud Implementations using Application Connector and FQDN Pools"
